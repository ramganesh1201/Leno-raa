    ...
    <div className="space-y-6 max-w-7xl">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div>
          ...
          <p className="text-neutral-500 mt-1">
            Manage the structure and content of your storefront homepage.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white dark:bg-neutral-900 rounded-2xl border border-neutral-200 dark:border-neutral-800 shadow-sm p-4 h-[calc(100vh-200px)] overflow-y-auto custom-scrollbar">
          <h2 className="text-sm font-bold uppercase tracking-widest text-neutral-500 mb-4 px-2">
            Page Layout (Drag to Reorder)
          </h2>
          <div className="space-y-2">
            {sections.map((section) => (
              ...
              >
                <div
                  className="cursor-grab active:cursor-grabbing p-1 text-neutral-400 hover:text-neutral-600 dark:hover:text-neutral-200"
          ...
          <div className="p-6 border-b border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-950/50 rounded-t-2xl flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold">
                {sections.find((s) => s.id === activeEditor)?.title} Editor
              </h2>
          ...
          <div className="p-6 flex-1 overflow-y-auto custom-scrollbar space-y-6">
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    defaultValue="Nature's Purest Essence."
                  />
                </div>
                <div>
                  ...
                  <textarea
                    rows={3}
                    className="w-full bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg p-2.5 outline-none focus:border-blue-500 transition-colors"
                    defaultValue="Handcrafted luxury soaps made with organic ingredients for a mindful bathing ritual."
                  ></textarea>
                </div>
                <div>
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg p-2.5 outline-none focus:border-blue-500 transition-colors"
                    defaultValue="Free shipping on orders over ₹1500"
                  />
                </div>
                <div>
                  ...
                  <input
                    type="color"
                    className="w-full h-12 bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg p-1 outline-none cursor-pointer"
                    defaultValue="#1a1a1a"
                  />
                </div>
                <div>
            ...
            {activeEditor !== "hero" && activeEditor !== "announcement" && (
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="flex flex-col items-center justify-center h-full text-neutral-500 text-center space-y-4"
              >
                ...
                <div>
                  ...
                  <p className="text-sm mt-1 max-w-sm">
                    This section pulls content automatically based on your products and collections
                    configuration.
                  </p>
                </div>
              </motion.div>
