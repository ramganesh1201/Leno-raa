      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <input
            ...
            className="w-full bg-black/5 dark:bg-white/5 border border-[color:var(--border)] p-3 rounded-lg text-sm focus:border-[color:var(--gold)] outline-none transition-colors"
            autoComplete="name"
          />
        </div>
        <div>
