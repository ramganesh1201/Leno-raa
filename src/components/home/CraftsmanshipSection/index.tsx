    ...
    >
      <div className="mx-auto max-w-[1400px] px-6 md:px-12">
        ...
        <div className="mb-16 md:mb-24 flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <Reveal as="p" preset="paragraph" delay={0.2} className="text-[color:var(--muted-foreground)] max-w-sm text-sm leading-relaxed">
            A journey through our artisanal process. We believe luxury is found in the time taken to craft something beautiful.
          </Reveal>
        </div>
