...
const CollectionCard = memo(function CollectionCard({
  ...
  handleCardHover: (index: number | null, collection?: any) => void;
}) {
      ...
      >
        ...
        <div className="absolute inset-0 w-full h-full bg-[color:var(--card)] overflow-hidden">
          <img
            ...
            loading="lazy"
            decoding="async"
            className={`w-full h-full ${config.imagePosition} object-cover transition-transform duration-[1200ms] ease-out group-hover:scale-105 will-change-transform`}
          />
        </div>
