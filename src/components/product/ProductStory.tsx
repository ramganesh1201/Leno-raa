  ...
  return (
    <section className="relative my-32 py-24 overflow-hidden rounded-[32px] bg-[color:var(--foreground)] px-6 md:px-12 text-[color:var(--background)]">
      ...
      <div className="relative z-10 mx-auto max-w-3xl text-center">
        ...
        >
          Rooted in ancient traditions and perfected through modern cold-process techniques, each
          bar is cured for six weeks to preserve its natural glycerin and botanical integrity.
        </Reveal>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-10 border-t border-white/10 pt-16">
          <Reveal delay={0.3} className="text-left">
            ...
            <p className="text-sm text-white/60 leading-relaxed">
              Sourced from the finest growers, capturing the essence of the {theme} environment at
              its peak.
            </p>
          </Reveal>
          <Reveal delay={0.4} className="text-left">
            ...
            <p className="text-sm text-white/60 leading-relaxed">
              Hand-poured and cut in small batches. The slow curing process ensures a harder,
              longer-lasting bar.
            </p>
          </Reveal>
          <Reveal delay={0.5} className="text-left">
            ...
            <p className="text-sm text-white/60 leading-relaxed">
              Transforms the daily shower into a meditative sanctuary, leaving skin velvet-soft and
              nourished.
            </p>
          </Reveal>
        </div>
